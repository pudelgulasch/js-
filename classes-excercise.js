...
const Sonja = new Person("Sonja", 20);
console.log(Sonja.describe());
...
class volumeOfCylinder {
  constructor(radius, height) {
    this.radius = radius;
    this.height = height;
    this.V = Math.PI * Math.pow(this.radius, 2) * this.height;
  }
  volume() {
...
const firstCylinder = new volumeOfCylinder(15, 30);
